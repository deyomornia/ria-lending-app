    ...
    <div className="mx-auto max-w-4xl space-y-6">
      <div className="flex items-start justify-between">
        <div>
          ...
          {borrower.address && <p className="text-sm text-slate-500">{borrower.address}</p>}
          {borrower.id_type && (
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="md:col-span-2">
          <h2 className="mb-2 text-sm font-semibold uppercase tracking-wide text-slate-500">Loans</h2>
