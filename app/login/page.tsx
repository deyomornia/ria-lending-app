    ...
    <main className="flex min-h-screen items-center justify-center bg-base-200 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-2xl font-bold text-base-content">RIA Lending</h1>
          <p className="mt-1 text-sm text-base-content/70">Staff sign-in</p>
        </div>
        <form
        ...
        <p className="mt-4 text-center text-sm text-base-content/70">
          Borrower? <a href="/portal/login" className="font-medium text-primary">View your loan here</a>
        </p>
      </div>
    </main>
  );
